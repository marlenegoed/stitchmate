...
import DemoSectionTitle from '@/components/demo/demo-section-title'


// const DemoProgress = dynamic(() => import('../../components/demo/demo-progress'), {ssr: false})


export default function Page({}) {

  const {numOfRows, reminders} = useDemoStore(state => state)
