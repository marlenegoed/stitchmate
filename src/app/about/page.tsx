  ...
  return (
    <div className='text-gray-900 flex flex-col text-left p-6 text-2xl sm:text-3xl h-[calc(100vh_-_4rem)] font-medium max-w-screen-lg mx-auto space-y-10 justify-between'>
      ...
      <div className='space-y-10 pb-10'>
        ...
        <section className='flex justify-between w-full sm:items-center'>
          ...
          <Button size="lg" variant="outline" className="col-start-3 w-fit border-black hover:bg-black hover:border-black text-black hover:text-white transition hover:transition-all hover:duration-700 duration-700 rounded-lg" onClick={() => router.back()}>
            go back
        ...
        <section className="grid md:grid-cols-3 gap-8 lg:gap-28 border-t pt-10">

          <p className="text-base/8 sm:text-lg/8">
            My source code: <a href="https://github.com/marlenegoed/stitchmate" className="font-semibold whitespace-nowrap">github
              <FaGithub className='inline -mt-1 ml-2' size={24} /></a>
          </p>

          <p className="text-base/8 sm:text-lg/8 md:justify-self-center">
            Crafting on social: 
          ...
          <p className="text-base/8 sm:text-lg/8 md:justify-self-end">
