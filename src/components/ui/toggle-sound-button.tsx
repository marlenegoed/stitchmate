...
export function ToggleSound({sound, onToggle}: {sound: boolean, onToggle?: () => void}) {
  ...
  return (
    ...
    <Button type='button' size='icon' variant='outline' className='h-8 w-8 border-neutral-300 hover:border-neutral-300 hover:bg-neutral-100 rounded-full' onClick={toggleSound}>
      {speaker}
    </Button>
    // </Tooltip>
  )
