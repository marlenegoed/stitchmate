  ...
  return (
    (<DayPicker
      ...
      classNames={{
        ...
        day: "h-8 w-8 p-0 font-normal aria-selected:opacity-100 hover:bg-neutral-100 rounded-full",
        day_range_end: "",
        day_selected:
          "bg-neutral-100 rounded-full font-semibold hover:bg-neutral-200 focus:bg-neutral-100 dark:bg-slate-50 dark:text-slate-900 dark:hover:bg-slate-50 dark:hover:text-slate-900 dark:focus:bg-slate-50 dark:focus:text-slate-900",
        day_today: "font-semibold text-sienna-400 dark:bg-slate-800 dark:text-slate-50",
        day_outside:
