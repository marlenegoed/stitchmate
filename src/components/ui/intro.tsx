...
<section className="max-w-screen-lg flex justify-center flex-col items-center mx-auto text-center h-full">
  ...
  <h4 className={`${kalam.className} font-bold text-slate-800 lg:text-8xl md:text-7xl sm:text-6xl text-5xl mb-8`}>welcome to all you knitters, crocheters and yarn lovers!</h4>
  <p className={` text-slate-800 text-2xl font-semibold mb-8`}>stitchmate keeps track while you stay focused on your craft.</p>
