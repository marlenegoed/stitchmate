...
export default function AddReminder({sectionId}: {sectionId: number}) {
  ...
  return (
    <div className='hover:cursor-pointer hover:bg-viridian-200/75 transition-colors relative w-20 sm:w-40 h-40 flex bg-viridian-100 sm:flex-col rounded-xl py-3 px-4 shadow-sm justify-center sm:justify-between'>
