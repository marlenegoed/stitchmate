...
export default function ReminderItem({reminder}: {reminder: Reminder}) {
  ...
  return (
    <div className={clsx({'opacity-50': !notification})}>
      <div className='min-h-52 flex flex-col h-full rounded-lg py-3 px-4 w-44 sm:w-52 border border-dashed border-neutral-400'>
...
export function ReminderDefaultItem() {
  ...
  return (
    <div className='flex flex-col text-left h-full rounded-lg py-3 px-4 min-h-52 w-44 sm:w-52 border border-dashed border-neutral-400'>
