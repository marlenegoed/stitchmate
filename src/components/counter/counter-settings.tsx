...
export default function CounterSettings({className}: {className: string}) {
    ...
    <div className={cn("flex items-center justify-center", className)} >
      <Sheet open={open} onOpenChange={setOpen}>
        ...
        <SheetContent side={side}>
          ...
          <CounterSettingsForm setOpen={setOpen} />
...
function CounterSettingsForm({setOpen}: {setOpen: (value: boolean) => void}) {
